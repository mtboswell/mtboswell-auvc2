...
#define TARGET_HEADING 186
#define TARGET_DEPTH 0.05
...
int main(int argc, const char *argv[])
{
	...
	while (rtmGetErrorStatus(StraightLevelControl_M) == (NULL)) {
		...
		motorspeeds[0] = (100+StraightLevelControl_Y.ChangetoLeft)%127;
		motorspeeds[1] = (100+StraightLevelControl_Y.ChangetoRight)%127;
