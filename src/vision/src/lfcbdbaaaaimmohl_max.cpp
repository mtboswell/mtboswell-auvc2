/*
 * File: /home/auvt/auvc/src/vision/Final_Models/slprj/ert/_sharedutils/lfcbdbaaaaimmohl_max.cpp
 *
...
void lfcbdbaaaaimmohl_max(const real_T varargin_1[150], real_T maxval[50])
{
  int32_T ix;
  int32_T iy;
  real_T mtmp;
