 ...
 *
 * Model version                        : 1.1380
 * Real-Time Workshop file version      : 7.6  (R2010b)  03-Aug-2010
 * Real-Time Workshop file generated on : Fri Jul 15 09:44:20 2011
 * TLC version                          : 7.6 (Jul 13 2010)
 * C/C++ source code generated on       : Fri Jul 15 09:44:21 2011
 *
...
void VisionM_ReferenceColorSelection(const real_T rtu_L[4800], const real_T
  rtu_a[4800], const real_T rtu_b[4800], const real_T rtu_Dist_Thresh[19200],
  ...
  while (i <= 60) {
    ...
    while ((i <= 60) && (flag == 0)) {
      ...
      while ((j <= 80) && (flag == 0)) {
        ...
        if ((min_dist > rtu_Dist_Thresh[0]) && (num_colors < 50)) {
          /* '<S22>:1:45' */
          /* '<S22>:1:46' */
...
void VisionModel_step(void)
{
  ...
  if ((VisionModel_U.ModeSelect == 1.0) || (VisionModel_U.ModeSelect == 3.0) ||
    ...
    VisionM_ReferenceColorSelection(VisionModel_B.Resize_e,
      ...
      &VisionModel_U.IterSegmentThresh[0],
