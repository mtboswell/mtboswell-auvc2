...
/* Block signals for system '<S55>/Transform Coordinates3' */
typedef struct {
  real_T points[2];                    /* '<S55>/Transform Coordinates3' */
...
typedef struct {
  ...
  real_T HoughTransform1_o1[71820];    /* '<S12>/Hough Transform1' */
  real_T HoughTransform1_o2[180];      /* '<S12>/Hough Transform1' */
  real_T HoughTransform1_o3[399];      /* '<S12>/Hough Transform1' */
  real_T Constant3;                    /* '<S12>/Constant3' */
  real_T Constant4;                    /* '<S12>/Constant4' */
  real_T DrawShapes_o1[19200];         /* '<S55>/Draw Shapes' */
  real_T DrawShapes_o2[19200];         /* '<S55>/Draw Shapes' */
  real_T DrawShapes_o3[19200];         /* '<S55>/Draw Shapes' */
  ...
  real_T bw_image[19200];              /* '<S2>/Blob Extraction' */
  ...
  real_T Gain5[19200];                 /* '<S5>/Gain5' */
  real_T Gain4[19200];                 /* '<S5>/Gain4' */
  real_T Gain3[19200];                 /* '<S5>/Gain3' */
  ...
  int32_T HoughLines[12];              /* '<S55>/Hough Lines' */
  boolean_T EdgeDetection1[19200];     /* '<S6>/Edge Detection1' */
  boolean_T EdgeDetection[19200];      /* '<S12>/Edge Detection' */
  ...
  rtB_TransformCoordinates3_Visio sf_TransformCoordinates3;/* '<S55>/Transform Coordinates3' */
...
struct rtP_validation_gate_VisionModel_ {
  real_T ColorFilter1_Value[7];        /* Expression: [1 0 0 0 1 0 0]
...
struct Parameters_VisionModel_ {
  real_T Dist_Thresh_Value;            /* Expression: Iter_Segment_Thresh
                                        * Referenced by: '<S1>/Dist_Thresh'
                                        */
  real_T Dist_Thresh_Value_k;          /* Expression: Iter_Segment_Thresh
                                        * Referenced by: '<S2>/Dist_Thresh'
                                        */
  real_T DrawTarget_RTP_FILLCOLOR[3];  /* Expression: color
                                        * Referenced by: '<S55>/Draw Target'
                                        */
  real_T DrawTarget_RTP_SIZE;          /* Expression: size
                                        * Referenced by: '<S55>/Draw Target'
                                        */
 ...
 * '<S50>'  : VisionModel/torpedo/Analyze LabelMatrix for Targets
 * '<S51>'  : VisionModel/torpedo/Decide which target to follow
 * '<S52>'  : VisionModel/torpedo/If Action Subsystem
 * '<S53>'  : VisionModel/torpedo/If Action Subsystem/Transform Coordinates3
 * '<S54>'  : VisionModel/validation_gate/Identify Validation Gate
 * '<S55>'  : VisionModel/validation_gate/If Action Subsystem
 * '<S56>'  : VisionModel/validation_gate/If Action Subsystem/Transform Coordinates3
 */
