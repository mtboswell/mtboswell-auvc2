...
typedef struct {
  real_T path_detectormdl_o1;          /* '<S1>/path_detector.mdl' */
  real_T path_detectormdl_o2;          /* '<S1>/path_detector.mdl' */
  real_T path_detectormdl_o3;          /* '<S1>/path_detector.mdl' */
  real_T path_detectormdl_o4;          /* '<S1>/path_detector.mdl' */
  real_T path_detectormdl_o5;          /* '<S1>/path_detector.mdl' */
  real_T path_detectormdl_o6;          /* '<S1>/path_detector.mdl' */
  real_T path_detectormdl_o7;          /* '<S1>/path_detector.mdl' */
  real_T validation_gatemdl_o1;        /* '<S7>/validation_gate.mdl' */
  real_T validation_gatemdl_o2;        /* '<S7>/validation_gate.mdl' */
  real_T validation_gatemdl_o3;        /* '<S7>/validation_gate.mdl' */
  real_T validation_gatemdl_o4;        /* '<S7>/validation_gate.mdl' */
  real_T validation_gatemdl_o5;        /* '<S7>/validation_gate.mdl' */
  real_T validation_gatemdl_o6;        /* '<S7>/validation_gate.mdl' */
  real_T validation_gatemdl_o7;        /* '<S7>/validation_gate.mdl' */
} BlockIO_VisionModel;
...
typedef struct {
  ...
  real_T BuoyColors[50];               /* '<Root>/BuoyColors' */
