 ...
 * Real-Time Workshop file generated on : Tue Jun 21 02:40:37 2011
 * TLC version                          : 7.6 (Jul 13 2010)
 * C/C++ source code generated on       : Tue Jun 21 02:40:37 2011
 *
...
typedef struct {
  real_T ColorSpaceConversion2_o1[307200];/* '<S4>/Color Space  Conversion2' */
  real_T ColorSpaceConversion2_o2[307200];/* '<S4>/Color Space  Conversion2' */
  real_T ColorSpaceConversion2_o3[307200];/* '<S4>/Color Space  Conversion2' */
  real_T ColorSpaceConversion4_o1[307200];/* '<S2>/Color Space  Conversion4' */
  real_T ColorSpaceConversion4_o2[307200];/* '<S2>/Color Space  Conversion4' */
  real_T ColorSpaceConversion4_o3[307200];/* '<S2>/Color Space  Conversion4' */
  real_T validation_gatemdl_o1;        /* '<S9>/validation_gate.mdl' */
  real_T validation_gatemdl_o2;        /* '<S9>/validation_gate.mdl' */
  real_T validation_gatemdl_o3;        /* '<S9>/validation_gate.mdl' */
  real_T validation_gatemdl_o4;        /* '<S9>/validation_gate.mdl' */
  real_T validation_gatemdl_o5;        /* '<S9>/validation_gate.mdl' */
  real_T validation_gatemdl_o6;        /* '<S9>/validation_gate.mdl' */
  real_T validation_gatemdl_o7;        /* '<S9>/validation_gate.mdl' */
  ...
  real_T ColorSpaceConversion3_o1[307200];/* '<S2>/Color Space  Conversion3' */
  real_T ColorSpaceConversion3_o2[307200];/* '<S2>/Color Space  Conversion3' */
  real_T ColorSpaceConversion3_o3[307200];/* '<S2>/Color Space  Conversion3' */
  real_T TmpSignalConversionAttorp_d[307200];
  real_T TmpSignalConversionAttorp_b[307200];
  real_T TmpSignalConversionAttorped[307200];
  real_T Gain5[307200];                /* '<S4>/Gain5' */
  real_T Gain4[307200];                /* '<S4>/Gain4' */
  real_T Gain3[307200];                /* '<S4>/Gain3' */
} BlockIO_VisionModel;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T ColorSpaceConversion1_DWORK1[307200];/* '<S4>/Color Space  Conversion1' */
  real_T ColorSpaceConversion2_DWORK1[307200];/* '<S4>/Color Space  Conversion2' */
  real_T ColorSpaceConversion3_DWORK1[307200];/* '<S2>/Color Space  Conversion3' */
  real_T ColorSpaceConversion4_DWORK1[307200];/* '<S2>/Color Space  Conversion4' */
  rtMdlrefDWork_mr_drop_mech drop_mechmdl_DWORK1;/* '<S3>/drop_mech.mdl' */
  rtMdlrefDWork_mr_drop_mech L_detectormdl_DWORK1;/* '<S6>/L_detector.mdl' */
  rtMdlrefDWork_mr_torpedo torpedomdl_DWORK1;/* '<S8>/torpedo.mdl' */
  rtMdlrefDWork_mr_path_detector path_detectormdl_DWORK1;/* '<S7>/path_detector.mdl' */
  rtMdlrefDWork_mr_validation_gat validation_gatemdl_DWORK1;/* '<S9>/validation_gate.mdl' */
} D_Work_VisionModel;

/* External inputs (root inport signals with auto storage) */
typedef struct {
  real_T R_forward_in[307200];         /* '<Root>/R_forward_in' */
  real_T G_forward_in[307200];         /* '<Root>/G_forward_in' */
  real_T B_forward_in[307200];         /* '<Root>/B_forward_in' */
  real_T R_down_in[307200];            /* '<Root>/R_down_in' */
  real_T G_down_in[307200];            /* '<Root>/G_down_in' */
  real_T B_down_in[307200];            /* '<Root>/B_down_in' */
