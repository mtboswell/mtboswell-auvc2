...
typedef struct {
  real_T Iout[307200];                 /* '<S4>/Low Pass Filter' */
  real_T Itemp[304964];
} rtB_LowPassFilter_torpedo;

/* Block signals for model 'torpedo' */
typedef struct {
  real_T ColorSpaceConversion1_o1[307200];/* '<S2>/Color Space  Conversion1' */
  real_T ColorSpaceConversion1_o2[307200];/* '<S2>/Color Space  Conversion1' */
  real_T ColorSpaceConversion1_o3[307200];/* '<S2>/Color Space  Conversion1' */
  boolean_T LogicMatrix[307200];
  ...
  real_T LabelMatrix[307200];          /* '<S5>/LabSegmentation' */
...
typedef struct {
  real_T ColorSpaceConversion1_DWORK1[307200];/* '<S2>/Color Space  Conversion1' */
  ...
  uint32_T STACK_DW[307200];           /* '<S3>/Blob Extraction' */
  int16_T N_PIXLIST_DW[307200];        /* '<S3>/Blob Extraction' */
  int16_T M_PIXLIST_DW[307200];        /* '<S3>/Blob Extraction' */
  real_T Resize_IntBuffer[51200];      /* '<S11>/Resize' */
  real_T Resize1_IntBuffer[51200];     /* '<S11>/Resize1' */
  real_T Resize2_IntBuffer[51200];     /* '<S11>/Resize2' */
  uint8_T PAD_DW[309444];              /* '<S3>/Blob Extraction' */
  real_T Resize2_LineBuffer[640];      /* '<S11>/Resize2' */
} rtDW_mr_torpedo;
...
extern void mr_torpedo_initialize(const char_T **rt_errorStatus,
  RT_MODEL_torpedo *const torpedo_M, rtB_mr_torpedo *localB, rtDW_mr_torpedo
  *localDW);
extern void torpedo_LowPassFilter(const real_T rtu_I[307200],
  rtB_LowPassFilter_torpedo *localB);
extern void mr_torpedo_Init(rtDW_mr_torpedo *localDW);
extern void mr_torpedo(const real_T rtu_R_forward_in[307200], const real_T
