...
void mr_path_detector_Init(rtDW_mr_path_detector *localDW)
{
  ...
  for (nonZeroIdx = 0; nonZeroIdx < 6; nonZeroIdx++) {
    localDW->EdgeDetection_VO_DW[nonZeroIdx] =
      path_detector_ConstP.EdgeDetection_VRO_RTP[nonZeroIdx] * 480 +
    ...
    localDW->EdgeDetection_HO_DW[nonZeroIdx] =
      path_detector_ConstP.EdgeDetection_HRO_RTP[nonZeroIdx] * 480 +
...
void mr_path_detector(const real_T rtu_R_in[307200], const real_T rtu_G_in
                      [307200], const real_T rtu_B_in[307200],
                      ...
                      *localDW)
{
  ...
  for (imgIdx_r = 0; imgIdx_r < 307200; imgIdx_r++) {
  ...
  for (imgCol = 1; imgCol < 639; imgCol++) {
    for (imgRow = 1; imgRow < 479; imgRow++) {
      accumOne = 0.0;
      accumTwo = 0.0;
      imgIdx_r = imgCol * 480 + imgRow;
      for (m = 0; m < 6; m++) {
  ...
  for (m = 0; m < 6; m++) {
    ...
    accumThree += localB->ColorSpaceConversion1_o3[479 +
      localDW->EdgeDetection_VOLL_DW[m]] *
      path_detector_ConstP.EdgeDetection_VC_RTP[m];
    accumFour += localB->ColorSpaceConversion1_o3[479 +
  ...
  localDW->EdgeDetection_GV_SQUARED_DW[479] = accumThree * accumThree;
  localDW->EdgeDetection_GH_SQUARED_DW[479] = accumFour * accumFour;
  accumOne = 0.0;
  accumTwo = 0.0;
  accumThree = 0.0;
  accumFour = 0.0;
  for (m = 0; m < 6; m++) {
    accumOne += localB->ColorSpaceConversion1_o3[306720 +
      localDW->EdgeDetection_VOUR_DW[m]] *
      path_detector_ConstP.EdgeDetection_VC_RTP[m];
    accumTwo += localB->ColorSpaceConversion1_o3[306720 +
      localDW->EdgeDetection_HOUR_DW[m]] *
      path_detector_ConstP.EdgeDetection_HC_RTP[m];
    accumThree += localB->ColorSpaceConversion1_o3[307199 +
      localDW->EdgeDetection_VOLR_DW[m]] *
      path_detector_ConstP.EdgeDetection_VC_RTP[m];
    accumFour += localB->ColorSpaceConversion1_o3[307199 +
      localDW->EdgeDetection_HOLR_DW[m]] *
      path_detector_ConstP.EdgeDetection_HC_RTP[m];
  }

  localDW->EdgeDetection_GV_SQUARED_DW[306720] = accumOne * accumOne;
  localDW->EdgeDetection_GH_SQUARED_DW[306720] = accumTwo * accumTwo;
  ...
  for (imgCol = 0; imgCol < 640; imgCol++) {
    for (imgRow = 0; imgRow < 480; imgRow++) {
      m = imgCol * 480 + imgRow;
      localB->EdgeDetection[m] = ((localDW->EdgeDetection_GRAD_SUM_DW[m] >
        ...
        ? localDW->EdgeDetection_GRAD_SUM_DW[m - 480] <=
        localDW->EdgeDetection_GRAD_SUM_DW[m] : TRUE) && (imgCol != 639 ?
        localDW->EdgeDetection_GRAD_SUM_DW[m] >
        localDW->EdgeDetection_GRAD_SUM_DW[m + 480] : TRUE)) ||
                      ((localDW->EdgeDetection_GH_SQUARED_DW[m] >=
                        localDW->EdgeDetection_GV_SQUARED_DW[m]) && (imgRow != 0
        ? localDW->EdgeDetection_GRAD_SUM_DW[m - 1] <=
        localDW->EdgeDetection_GRAD_SUM_DW[m] : TRUE) && (imgRow != 479 ?
        localDW->EdgeDetection_GRAD_SUM_DW[m] >
  ...
  MWVIP_Hough_D(&localB->EdgeDetection[0], &localB->HoughTransform1_o1[0],
                ...
                &path_detector_ConstP.HoughTransform1_FIRSTRHO_R, 480, 640, 1599,
                91);
