...
/* Block signals for system '<S6>/Low Pass Filter' */
typedef struct {
  real_T Iout[19200];                  /* '<S6>/Low Pass Filter' */
  real_T Itemp[18644];
...
typedef struct {
  ...
  real_T Resize[4800];                 /* '<S13>/Resize' */
  real_T Resize1[4800];                /* '<S13>/Resize1' */
  real_T Resize2[4800];                /* '<S13>/Resize2' */
  real_T ColorSpaceConversion1_o1_e[19200];/* '<Root>/Color Space  Conversion1' */
  ...
  real_T ref_colors[150];              /* '<S7>/Reference Color Selection' */
  real_T num_colors;                   /* '<S7>/Reference Color Selection' */
  real_T LabelMatrix[19200];           /* '<S7>/LabSegmentation' */
  real_T ColorSpaceConversion1_o2_d[19200];/* '<Root>/Color Space  Conversion1' */
  real_T ColorSpaceConversion1_o3_n[19200];/* '<Root>/Color Space  Conversion1' */
  real_T L[19200];                     /* '<Root>/Transform Coordinates1' */
  ...
  rtB_LowPassFilter_buoy_detector sf_LowPassFilter2;/* '<S6>/Low Pass Filter2' */
  rtB_LowPassFilter_buoy_detector sf_LowPassFilter1;/* '<S6>/Low Pass Filter1' */
  rtB_LowPassFilter_buoy_detector sf_LowPassFilter;/* '<S6>/Low Pass Filter' */
...
typedef struct {
  ...
  real_T ColorSpaceConversion1_DWORK1_o[19200];/* '<Root>/Color Space  Conversion1' */
  real_T Resize_IntBuffer[12800];      /* '<S13>/Resize' */
  real_T Resize1_IntBuffer[12800];     /* '<S13>/Resize1' */
  real_T Resize2_IntBuffer[12800];     /* '<S13>/Resize2' */
...
extern void mr_buoy_detector(const real_T rtu_R_forward_in[19200], const real_T
  rtu_G_forward_in[19200], const real_T rtu_B_forward_in[19200], const real_T
  *rtu_WhichColor, real_T *rty_TargetSelect, real_T *rty_TargetFound, real_T
  *rty_MaintainHeading, real_T *rty_TargetY, real_T *rty_TargetZ, real_T
  *rty_TargetYaw, real_T *rty_TargetDetected, real_T rty_BuoyColors[50], real_T
  rty_R[19200], real_T rty_G[19200], real_T rty_B[19200], rtB_mr_buoy_detector
 ...
 *
 * '<Root>' : buoy_detector
 * '<S1>'   : buoy_detector/Choose Buoy
 * '<S2>'   : buoy_detector/IterativeSegmentation
 * '<S3>'   : buoy_detector/Look for Buoys
 * '<S4>'   : buoy_detector/Transform Coordinates1
 * '<S5>'   : buoy_detector/Transform Coordinates3
 * '<S6>'   : buoy_detector/IterativeSegmentation/Low Pass Filter
 * '<S7>'   : buoy_detector/IterativeSegmentation/Segmentation
 * '<S8>'   : buoy_detector/IterativeSegmentation/Low Pass Filter/Low Pass Filter
 * '<S9>'   : buoy_detector/IterativeSegmentation/Low Pass Filter/Low Pass Filter1
 * '<S10>'  : buoy_detector/IterativeSegmentation/Low Pass Filter/Low Pass Filter2
 * '<S11>'  : buoy_detector/IterativeSegmentation/Segmentation/LabSegmentation
 * '<S12>'  : buoy_detector/IterativeSegmentation/Segmentation/Reference Color Selection
 * '<S13>'  : buoy_detector/IterativeSegmentation/Segmentation/Resize
 * '<S14>'  : buoy_detector/Look for Buoys/Blob Extraction
 * '<S15>'  : buoy_detector/Look for Buoys/Color Analysis
 * '<S16>'  : buoy_detector/Look for Buoys/Shape Analysis
 */
