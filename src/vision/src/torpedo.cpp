 ...
 * Real-Time Workshop file generated on : Tue Jun  7 22:51:27 2011
 * TLC version                          : 7.6 (Jul 13 2010)
 * C/C++ source code generated on       : Tue Jun  7 22:51:27 2011
 *
                ...
                rtB_mr_torpedo *localB, rtDW_mr_torpedo *localDW)
{
  ...
  for (j = 0; j < 120; j++) {
    ...
    for (num_colors = 0; num_colors < 80; num_colors++) {
      i = num_colors + 80;
      min_dist = localB->
        ColorSpaceConversion1_o1[torpedo_ConstP.pooled4[num_colors] * 120 + j] *
        torpedo_ConstP.pooled2[num_colors] + localB->
        ColorSpaceConversion1_o1[torpedo_ConstP.pooled4[i] * 120 + j] *
        torpedo_ConstP.pooled2[i];
      i += 80;
      min_dist += localB->ColorSpaceConversion1_o1[torpedo_ConstP.pooled4[i] *
        120 + j] * torpedo_ConstP.pooled2[i];
      i += 80;
      min_dist += localB->ColorSpaceConversion1_o1[torpedo_ConstP.pooled4[i] *
        120 + j] * torpedo_ConstP.pooled2[i];
  ...
  for (num_colors = 0; num_colors < 80; num_colors++) {
    ...
    for (j = 0; j < 60; j++) {
      i = j + 60;
      min_dist = Resize2_LineBuffer[torpedo_ConstP.pooled3[j]] *
        torpedo_ConstP.pooled1[j] + Resize2_LineBuffer[torpedo_ConstP.pooled3[i]]
        * torpedo_ConstP.pooled1[i];
      i += 60;
      min_dist += Resize2_LineBuffer[torpedo_ConstP.pooled3[i]] *
        torpedo_ConstP.pooled1[i];
      i += 60;
      min_dist += Resize2_LineBuffer[torpedo_ConstP.pooled3[i]] *
        torpedo_ConstP.pooled1[i];
  ...
  for (j = 0; j < 120; j++) {
    ...
    for (num_colors = 0; num_colors < 80; num_colors++) {
      i = num_colors + 80;
      min_dist = localB->
        ColorSpaceConversion1_o2[torpedo_ConstP.pooled4[num_colors] * 120 + j] *
        torpedo_ConstP.pooled2[num_colors] + localB->
        ColorSpaceConversion1_o2[torpedo_ConstP.pooled4[i] * 120 + j] *
        torpedo_ConstP.pooled2[i];
      i += 80;
  ...
  for (j = 0; j < 120; j++) {
    ...
    for (num_colors = 0; num_colors < 80; num_colors++) {
      i = num_colors + 80;
      min_dist = localB->
        ColorSpaceConversion1_o3[torpedo_ConstP.pooled4[num_colors] * 120 + j] *
        torpedo_ConstP.pooled2[num_colors] + localB->
        ColorSpaceConversion1_o3[torpedo_ConstP.pooled4[i] * 120 + j] *
        torpedo_ConstP.pooled2[i];
      i += 80;
