 ...
 * C++ source code generated on : Fri Jun 03 08:27:28 2011
 *
...
#define VisionModel_rtModel            RT_MODEL_VisionModel
...
typedef struct {
  ...
  rtMdlrefDWork_mr_path_detector path_detectormdl_DWORK1;/* '<S5>/path_detector.mdl' */
...
#define rtB                            VisionModel_B
#define BlockIO                        BlockIO_VisionModel
#define rtU                            VisionModel_U
#define ExternalInputs                 ExternalInputs_VisionModel
#define rtXdot                         VisionModel_Xdot
#define StateDerivatives               StateDerivatives_VisionModel
#define tXdis                          VisionModel_Xdis
#define StateDisabled                  StateDisabled_VisionModel
#define rtY                            VisionModel_Y
#define ExternalOutputs                ExternalOutputs_VisionModel
#define rtP                            VisionModel_P
#define Parameters                     Parameters_VisionModel
#define rtDWork                        VisionModel_DWork
#define D_Work                         D_Work_VisionModel
