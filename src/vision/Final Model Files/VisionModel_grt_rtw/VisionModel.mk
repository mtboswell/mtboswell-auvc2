...
#
# File    : grt_vc.tmf   $Revision: 1.71.4.33 $
#
# Abstract:
...
MODEL                = VisionModel
MODULES              = VisionModel_data.cpp rt_logging.c 
MAKEFILE             = VisionModel.mk
MATLAB_ROOT          = C:\Program Files\MATLAB\R2010b
ALT_MATLAB_ROOT      = C:\PROGRA~1\MATLAB\R2010b
MATLAB_BIN           = C:\Program Files\MATLAB\R2010b\bin
ALT_MATLAB_BIN       = C:\PROGRA~1\MATLAB\R2010b\bin
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\DOCUME~1\ADMINI~1\MYDOCU~1\ACADEM~1\SUMMER~1\AUVT\Models\FINALM~1
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MODELREFS            = buoy_detector drop_mech path_detector torpedo validation_gate 
...
TARGET_LANG_EXT      = cpp
MEX_OPT_FILE         = -f C:\DOCUME~1\ADMINI~1\APPLIC~1\MATHWO~1\MATLAB\R2010b\mexopts.bat
VISUAL_VER           = 9.0
...
MODELLIB                  = VisionModellib.lib
MODELREF_LINK_LIBS        = buoy_detector_rtwlib.lib drop_mech_rtwlib.lib path_detector_rtwlib.lib torpedo_rtwlib.lib validation_gate_rtwlib.lib 
MODELREF_LINK_RSPFILE     = VisionModel_ref.rsp
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\VisionModel_grt_rtw
