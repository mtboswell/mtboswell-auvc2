/*
 * Real-Time Workshop code generation for Simulink model 'path_detector'
 * For more details, see corresponding source file path_detector.c
 *
 */
...
extern void mr_path_detector_initialize(boolean_T firstTime, const char_T
  **rt_errorStatus, RT_MODEL_path_detector *const path_detector_M,
  rtB_mr_path_detector *localB, rtDW_mr_path_detector *localDW);
...
extern void mr_path_detector(const real_T rtu_R_in[19200], const real_T
  rtu_G_in[19200], const real_T rtu_B_in[19200], rtB_mr_path_detector *localB,
