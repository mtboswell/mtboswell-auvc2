        ...
        for(int c = 0; c < wsub; c++)
        {
            ...
            if(bw[c][r] == 1)
            {
                ...
                if(blob_track == -1)
                {
                    ...
                    // Determine blob_track; increment num_blobs as needed
                    if(r == 0)
                    {
                        ...
                        // A new blob is necessarily being tracked
                        num_blobs++;
                    ...
                    // Debugging note: This function will definitely fail for blobs which have arrays of vertical sections one pixel in width (like
                    //   prison bars). To account for these, blob_bound will need many more entries.





                    //num_blobs++; //don't change num_blobs here!!!
