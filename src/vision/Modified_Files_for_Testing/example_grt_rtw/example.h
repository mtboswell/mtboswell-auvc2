...
#define example_rtModel                RT_MODEL_example
...
#define rtXdot                         example_Xdot
#define StateDerivatives               StateDerivatives_example
#define tXdis                          example_Xdis
#define StateDisabled                  StateDisabled_example
#define rtY                            example_Y
#define ExternalOutputs                ExternalOutputs_example
#define rtP                            example_P
#define Parameters                     Parameters_example
