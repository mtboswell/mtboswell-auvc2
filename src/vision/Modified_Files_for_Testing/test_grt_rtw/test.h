...
typedef struct {
  ...
  real_T y[71820];                     /* '<Root>/Embedded MATLAB Function' */
  real_T HoughTransform_o2[180];       /* '<Root>/Hough Transform' */
  real_T HoughTransform_o3[399];       /* '<Root>/Hough Transform' */
  real_T ColorSpaceConversion[19200];  /* '<S1>/Color Space  Conversion' */
  int32_T HoughLines[4];               /* '<Root>/Hough Lines' */
  uint32_T Selector;                   /* '<Root>/Selector' */
...
typedef struct {
  ...
  uint32_T FindLocalMaxima_NUMPEAKS_DWORK;/* '<Root>/Find Local Maxima' */
} D_Work_test;
...
#define rtU                            test_U
#define ExternalInputs                 ExternalInputs_test
#define rtXdot                         test_Xdot
#define StateDerivatives               StateDerivatives_test
#define tXdis                          test_Xdis
#define StateDisabled                  StateDisabled_test
#define rtY                            test_Y
#define ExternalOutputs                ExternalOutputs_test
#define rtP                            test_P
#define Parameters                     Parameters_test
#define rtDWork                        test_DWork
#define D_Work                         D_Work_test
#define ConstParam                     ConstParam_test
#define rtcP                           test_ConstP
...
struct Parameters_test_ {
  real_T EdgeDetection_THRESH_TUNING_RTP;/* Expression: thresholdTuning
                                          * Referenced by: '<Root>/Edge Detection'
                                          */
  real_T FindLocalMaxima_THRESHOLD_RTP;/* Expression: threshold
...
/* External inputs (root inport signals with auto storage) */
extern ExternalInputs_test test_U;

/* External outputs (root outports fed by signals with auto storage) */
extern ExternalOutputs_test test_Y;

/* Constant parameters (auto storage) */
extern const ConstParam_test test_ConstP;
...
extern "C" {
  ...
  extern struct RT_MODEL_test *test_M;
 ...
 *
 * '<Root>' : test
 * '<S1>'   : test/Convert to BW
 * '<S2>'   : test/Embedded MATLAB Function
 * '<S3>'   : test/Convert to BW/Hue Higher Comparison
 * '<S4>'   : test/Convert to BW/Hue Lower Comparison
 */
