...
MODEL                = test
MODULES              = hough_d_rt.c hough_r_rt.c rtGetInf.cpp rtGetNaN.cpp rt_logging.c rt_nonfinite.cpp test_data.cpp 
MAKEFILE             = test.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\DOCUME~1\ADMINI~1\MYDOCU~1\ACADEM~1\SUMMER~1\AUVT\Models\MODIFI~1
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\test_grt_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\dspblks\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\vipblks\include
...
{$(MATLAB_ROOT)\toolbox\rtw\vipblks\c\viphough}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CFLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\rtw\vipblks\c\viphough}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
