...
void init_params(QHash<QString, double*>& parameters){
	...
	parameters.insert("Depth_Kd", &brain_P.MaintainDepth.Depth_Kd);
	parameters.insert("Depth_Ki", &brain_P.MaintainDepth.Depth_Ki);
	parameters.insert("Depth_Kp", &brain_P.MaintainDepth.Depth_Kp);
	parameters.insert("Heading_Forward_Velocity", &brain_P.GetForwardVelocity.Heading_Forward_Velocity);
	parameters.insert("Heading_Kd", &brain_P.MaintainHeading.Heading_Kd);
	parameters.insert("Heading_Ki", &brain_P.MaintainHeading.Heading_Ki);
	parameters.insert("Heading_Kp", &brain_P.MaintainHeading.Heading_Kp);
