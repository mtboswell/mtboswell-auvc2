...
state =
{
	Name = "TrueControllersInitParams";
	Command = "DeadReckon";
	Options =
	{
		count = 50;
		...
		o45_label = "Camera.Front.Pixelclock";
		o45_value = 12;
		
		o46_label = "Camera.Down.Pixelclock";
		o46_value = 12;
		
		o47_label = "DeadReckon.ForwardSpeed";
		o47_value = 0;
		
		o48_label = "DeadReckon.Heading";
		o48_value = 0;
		
		o49_label = "TargetOptions.Approach";
		o49_value = 1;
		
		o50_label = "Parameter.Vision.ModeSelect";
		o50_value = 1;
	};
};
addState(state);
