...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Sat Mar 13 20:28:47 2010
# Project:  agent.pro
# Template: app
...
moc_DashSocket.cpp: dashboard/DashSocket.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) dashboard/DashSocket.h -o moc_DashSocket.cpp
