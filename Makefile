...
# Generated by qmake (2.01a) (Qt 4.6.1) on: Sat Feb 20 15:16:07 2010
# Project:  agent.pro
# Template: app
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.6.1/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.6.1/include/QtCore -I/usr/local/Trolltech/Qt-4.6.1/include/QtGui -I/usr/local/Trolltech/Qt-4.6.1/include -I. -Ibrain -Iauv -Idashboard -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.6.1/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.6.1/lib -lQtGui -L/usr/local/Trolltech/Qt-4.6.1/lib -L/usr/X11R6/lib -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
