...
# Generated by qmake (2.01a) (Qt 4.6.1) on: Wed Mar 10 23:23:09 2010
# Project:  agent.pro
# Template: app
...
INCPATH       = -I/usr/share/qt/mkspecs/linux-g++ -I. -I/usr/include/QtCore -I/usr/include/QtNetwork -I/usr/include/QtGui -I/usr/include -I. -Ibrain -Iauv -Idashboard -Iserver -I. -I.
LINK          = g++
...
moc_model.cpp: auv/auvtypes.h \
		...
		parameters.h \
		model.h
	/usr/bin/moc $(DEFINES) $(INCPATH) model.h -o moc_model.cpp
