...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Thu Mar 11 17:50:18 2010
# Project:  agent.pro
# Template: app
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -Ibrain -Iauv -Idashboard -Imodel -Iserver -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
...
moc_dashboard.cpp: ui_dashboard.h \
	...
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) dashboard/dashboard.h -o moc_dashboard.cpp
...
moc_server.cpp: config.h \
		...
		model/parameters.h \
		server/server.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) server/server.h -o moc_server.cpp
...
moc_model.cpp: auv/auvtypes.h \
		...
		model/parameters.h \
		model/model.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) model/model.h -o moc_model.cpp
...
moc_auv.cpp: auv/auvtypes.h \
		...
		brain/brain_types.h \
		auv/auv.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) auv/auv.h -o moc_auv.cpp
...
ui_dashboard.h: dashboard/dashboard.ui
	/usr/bin/uic-qt4 dashboard/dashboard.ui -o ui_dashboard.h
